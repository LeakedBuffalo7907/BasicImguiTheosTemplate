...
namespace ImGui
{
    ...
    IMGUI_API void          SetImageBG(ImTextureID ImageToUse);
    ...
    IMGUI_API void          StyleColorsDarkRed(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsDarkLime(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsDarkness(bool custom = false, ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsPurpleBlue(ImGuiStyle* dst = NULL);
    ...
    IMGUI_API bool          CollapsingHeader(const char* label, int* select, int type ,ImGuiTreeNodeFlags flags = 0);
